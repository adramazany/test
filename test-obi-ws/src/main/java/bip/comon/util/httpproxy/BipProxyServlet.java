package bip.comon.util.httpproxy;
...
/**
 * Created by ramezani on 4/2/2020.
 */
public class BipProxyServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws ServletException, IOException {
        ...
        if(servletRequest.getHeader("Content-Length") == null && servletRequest.getHeader("Transfer-Encoding") == null) {
            ...
            try {
                ...
                throw new ServletException("error in URI",e);
            }
        }
    ...
    protected HttpRequest newProxyRequestWithEntity(String method, String proxyRequestUri, HttpServletRequest servletRequest) throws IOException, URISyntaxException {
//        if("POST".equalsIgnoreCase(method)){
//            URIBuilder builder = new URIBuilder(proxyRequestUri);
//            Enumeration paramNames = servletRequest.getParameterNames();
//            while(paramNames.hasMoreElements()){
//                String paramName = paramNames.nextElement().toString();
//                if(!"RedirectURL".equalsIgnoreCase(paramName)){
//                    builder.setParameter(paramName, servletRequest.getParameter(paramName));
//                }
//            }
//
//            HttpPost eProxyRequest = new HttpPost(builder.build());
//            eProxyRequest.getParams().setParameter()
...
//        }else{
        ...
        while(paramNames.hasMoreElements()){
            String paramName = paramNames.nextElement().toString();
            if(!"RedirectURL".equalsIgnoreCase(paramName)){
                eProxyRequest.getParams().setParameter(paramName, servletRequest.getParameter(paramName));
            }
        }
...
//        }
    ...
    protected String rewriteUrlFromRequest(HttpServletRequest servletRequest) {
        ...
        if(servletRequest.getParameter("RedirectURL")!=null){
            uri.append(servletRequest.getParameter("RedirectURL"));
        }else {
    ...
    protected static CharSequence encodeUriQuery(CharSequence in, boolean encodePercent) {
        ...
        for(int i = 0; i < in.length(); ++i) {
            ...
            boolean escape = true;
            if(c < 128) {
                if(asciiQueryChars.get(c) && (!encodePercent || c != 37)) {
                    escape = false;
                }
            ...
            if(!escape) {
                ...
                formatter.format("%%%02X", new Object[]{Integer.valueOf(c)});
            }
        }
