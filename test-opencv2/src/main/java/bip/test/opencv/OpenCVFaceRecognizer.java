...
public class OpenCVFaceRecognizer {
    public static void main(String[] args) {
        String trainingDir = "C:\\Users\\ramezani\\git\\test\\test-main\\test-opencv2\\src\\main\\resources\\faces-db\\mine";
        //Mat testImage = imread("C:\\Users\\ramezani\\git\\test\\test-main\\test-opencv2\\src\\main\\resources\\faces-db\\mine\\1.jpg", IMREAD_GRAYSCALE);
        Mat testImage = imread("C:\\Users\\ramezani\\git\\test\\test-main\\test-opencv2\\src\\main\\resources\\faces-db\\MultiPie\\001-01-01-051-00.jpg", IMREAD_GRAYSCALE);
        ...
        DoublePointer confidence = new DoublePointer(100);
        faceRecognizer.predict(testImage, label, confidence);
        for (int i = 0; i < label.sizeof(); i++) {
            int predictedLabel = label.get(i);
