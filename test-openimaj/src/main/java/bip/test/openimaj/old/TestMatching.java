...
public class TestMatching {
    ...
    public static void main(String[] args)throws Exception {
        //testBasicMatcher();
        testConsistentLocalFeatureMatcher2d();
    }

    public static void testBasicMatcher()throws IOException{
    ...
    public static void testConsistentLocalFeatureMatcher2d()throws Exception{
        MBFImage query = ImageUtilities.readMBF(new File(basePath+"s1/1.pgm"));
